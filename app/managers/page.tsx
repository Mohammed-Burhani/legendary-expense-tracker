...
import { UserCog, Building2, Plus, Users } from 'lucide-react';
import { useManagers, useSites, useLaborers, useAddManager } from '@/lib/query/hooks';
...
export default function ManagersPage() {
  ...
  const handleAddManager = async () => {
    ...
    try {
      await addManager.mutateAsync({ name: newManagerName.trim() });
